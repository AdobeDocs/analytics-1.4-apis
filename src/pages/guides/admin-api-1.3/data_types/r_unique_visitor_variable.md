# unique\_visitor\_variable

Data structure that contains information about commerce variable usage to track unique visitors.

|Element|Type|Description|
|-------|----|-----------|
|**unique\_visitor\_variable** |`xsd:string` | The number of the commerce variable used to track unique visitors. |
