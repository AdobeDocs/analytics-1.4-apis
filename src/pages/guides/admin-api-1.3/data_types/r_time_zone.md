...
Data structure that contains information about a report suite's time zone setting.

|Element|Type|Description|
|-------|----|-----------|
|**time\_zone** |`xsd:timezone_enum` | The time zone used to stamp report suite data. |
