...
API calls that do not meet the above requirements are omitted from reporting. XML tags are case-insensitive; capitalization is used only to assist readability.
