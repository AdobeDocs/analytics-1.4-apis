...
<request>
   ...
   <timestamp>YYYY-03-05T01:00:01-05</timestamp>
...
```
HTTP/1.1 200 OK
Date: Wed, 13 May YYYY 16:25:12 GMT
X-C: ms-3.7.2
Expires: Tue, 12 May YYYY 16:25:12 GMT
Last-Modified: Thu, 14 May YYYY 16:25:12 GMT
Cache-Control: no-cache, no-store, must-revalidate, max-age=0, proxy-revalidate, no-transform, private
Pragma: no-cache
