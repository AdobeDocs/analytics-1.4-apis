...
| `<pageURL>` |`g` | pageURL | N/A | The Web page URL For example, http://www.example.com/index.html. |
...
| `<reportSuiteID>` |Contained in the URL. See [HTTP GET Sample](../sample_code/r_sample_http_get.md#).| s_account | N/A | Specifies the report suites where you want to submit data. Separate multiple report suite IDs with a comma. |
